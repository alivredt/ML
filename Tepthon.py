...
async def join_channel():
    try:
        await Tepthon(JoinChannelRequest("@zlz1zl"))
        await Tepthon(JoinChannelRequest("@zlz1zl"))
...
async def _(event):
      await event.reply("""السـورس يعمـل علي احمد يعمل بنجاح @syntral
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍


- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها 
- للدخول لسوبر المطور تفضل - @TFFF_F .
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@Tepthon.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""علي احمد : @TFFF_F"""
)
